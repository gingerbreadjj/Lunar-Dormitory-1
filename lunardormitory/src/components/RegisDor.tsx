  ...
  return (
    <div>
      ...
      <div className="">
        ...
        <div className="flex flex-col mb-5 mt-5 mx-10">
          ...
          <div className="grid grid-cols-2">
            <div>
              ...
              <input className="border-2 border-gray rounded-lg p-2 w-2/4 shadow-2xl"></input>
            </div>
            <div>
        ...
        <div className="flex flex-col mb-5 mt-5 mx-10">
          <h1 className="mt-5 mb-3 font-medium text-lg">ตำแหน่งหอพัก :</h1>
        </div>
        <div className="flex flex-col mb-5 mt-5 mx-10">
          <div className="grid grid-cols-2">
            <div>
        ...
        <div className="flex flex-row mt-24 mx-10 gap-10 justify-end">
          <button
