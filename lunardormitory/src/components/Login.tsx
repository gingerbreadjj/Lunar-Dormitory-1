    ...
    <div className="flex">
      <div className="flex flex-col w-1/2 h-screen justify-center items-center">
        ...
        <div className="relative mb-3 w-5/12 flex items-center">
            ...
            <button className='bg-black rounded-xl p-2 w-full text-white '>เข้าสู่ระบบด้วย Google</button>
        </div>

        <button className='m-5 underline text-sm font-medium' style={{color:'#2E4E73'}}>ยังไม่มีบัญชี?</button>
      </div>
